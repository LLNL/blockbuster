...
LIBS +=  -LINSTALLDIR_PLACEHOLDER/lib -fPIC -LINSTALLDIR_PLACEHOLDER/lib -fPIC -LINSTALLDIR_PLACEHOLDER/lib -fPIC -LINSTALLDIR_PLACEHOLDER/lib   -lsmovie -lreadline   -lsrwpng -ljpeg -llzo2 -lz -llzma -lm -lboost_regex
